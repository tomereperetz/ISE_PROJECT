...
public class ReflectionRefractionTests {
	...
	public void trianglesTransparentSphere() {
		...
		camera.setImageWriter(imageWriter) //
				.setMultithreading(3).setDebugPrint(1)//
				.setRayTracer(new RayTracerBasic(scene)) //
				.renderImage() //
				.writeToImage();
	}
	...
	/**
	 * Produce a picture of two triangles and a two spheres lighted by 4 different sharp
	 * spot light sources
	 */
	@Test
	public void multipleGeometriesAndEffects() {
		Camera camera = new Camera(new Point(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0)) //
				.setVPSize(200, 200).setVPDistance(1000);
		...
		scene.geometries.add( //
				...
				new Triangle(new Point(-150, -150, -115), new Point(-70, 70, -140), new Point(75, 75, -150)) //
						.setMaterial(new Material().setKd(0.2).setKs(0.2).setShininess(10)), //
				new Sphere(new Point(0, 0, -50), 30d).setEmission(new Color(BLUE)) //
						.setMaterial(new Material().setKd(0.2).setKs(0.2).setShininess(30).setKt(0.5)),
				new Sphere(new Point(0, 0, -50), 15d).setEmission(new Color(RED)) //
						.setMaterial(new Material().setKd(0.05).setKs(0.05).setShininess(10)));

		scene.lights.add(new SpotLight(new Color(700, 400, 400), new Point(-10, -10, 0), new Vector(0, 0, -1)) //
				.setNarrowBeam(2).setKl(4E-5).setKq(2E-7));
		scene.lights.add(new SpotLight(new Color(700, 400, 400), new Point(-10, 10, 0), new Vector(0, 0, -1)) //
				.setNarrowBeam(2).setKl(4E-5).setKq(2E-7));
		scene.lights.add(new SpotLight(new Color(700, 400, 400), new Point(10, -10, 0), new Vector(0, 0, -1)) //
				.setNarrowBeam(2).setKl(4E-5).setKq(2E-7));
		...
		ImageWriter imageWriter = new ImageWriter("exerciseDuty", 600, 600);
